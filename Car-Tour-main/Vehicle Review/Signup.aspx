<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Signup.aspx.cs" Inherits="Vehicle_Review.Signup" %>
    ...
    <form id="form4" runat="server">
        ...
        <div class="form-group">
             <label for="exampleInputEmail1" id="email">Email</label>
              <asp:TextBox ID="TextBox3" CssClass="input form-control" runat="server" placeholder="Enter Email"></asp:TextBox><br />
            </div>
        <div class="form-group">
        ...
        <script>
            ...
            function varify() {
                ...
                if (fname < 4) {
                    ...
                    f = true;
                    document.getElementById("first").style.color = '#96c2d7';
            ...
            function varify1() {
                ...
                if (lname < 4) {
                    ...
                    f1 = true;
                    document.getElementById("last").style.color = '#96c2d7';
            ...
            function varify2() {
                ...
                if (email < 5) {
                    ...
                    f2 = true;
                    document.getElementById("email").style.color = '#96c2d7';
            ...
            function varify3() {
                ...
                if (uname < 7) {
                    ...
                    f3 = true;
                    document.getElementById("uname").style.color = '#96c2d7';
            ...
            function varify4() {
                ...
                if (pass < 7) {
                    ...
                    f4 = true;
                    document.getElementById("pass1").style.color = '#96c2d7';
            ...
            function varify5() {
                ...
                if (pass1 == pass2) {
                    ...
                    document.getElementById("pass2").style.color = '#96c2d7';
                    button.style.display = "block"; 
