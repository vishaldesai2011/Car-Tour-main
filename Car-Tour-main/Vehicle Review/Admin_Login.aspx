<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Login.aspx.cs" Inherits="Vehicle_Review.Admin_Login" %>
...
<body>
  ...
  <div class="left">
    ...
    <form id="form1" runat="server">
            ...
            <asp:Button ID="Button1" CssClass="btn1" runat="server" Text="Login" OnClick="Login"/>
        <br />
        <br />
