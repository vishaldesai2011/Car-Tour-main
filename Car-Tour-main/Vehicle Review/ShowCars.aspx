<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowCars.aspx.cs" Inherits="Vehicle_Review.ShowCars" %>
    ...
    <div class="con">
        ...
        <div class="cust-nav">
         <ul>
             ...
             <li  class="active"><a href="link1" class="active-a">Show Cars</a></li>
