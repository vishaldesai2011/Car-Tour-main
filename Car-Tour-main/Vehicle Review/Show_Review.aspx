<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show_Review.aspx.cs" Inherits="Vehicle_Review.Show_Review" %>
    ...
    <div class="con">
        ...
        <div class="cust-nav">
         <ul>
             ...
             <li><a href="Admin_Dashbord.aspx">Dashboard</a></li>
             ...
             <li class="active"><a class="active-a" href="Show_Review.aspx">Reviews</a></li>

            <%-- <asp:Label ID="Label6" CssClass="lbl" runat="server" Text=""></asp:Label>
             <li><a href="Contact_data.aspx">Contatct</a></li>--%>
        ...
        <%--Contenet START--%>
        <div class="other">
            <center><h1 class="heading">CARS</h1></center>
            <center>
