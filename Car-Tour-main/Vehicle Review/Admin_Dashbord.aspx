<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Dashbord.aspx.cs" Inherits="Vehicle_Review.Admin_Dashbord" %>
...
<head runat="server">
 ...
 <title>Admin</title>
    ...
    <body>
        ...
        <ul class="ul1">
            <li class="li1"><a href="ShowCars.aspx">Cars</a></li>
            <li class="li1"><a href="CarCompany.aspx">Company</a></li>
            <li class="li1"><a href="Admin_Users.aspx">Users</a></li>
        ...
        <div class="other"  onscroll="con()">
            <h2 class="heading">DashBord</h2>
                <div class="con">
                    ...
                    <div class="grid">
                        <span class="iconify" data-icon="ic:round-rate-review" style="color: #e71c62;" data-width="100" data-height="100"></span>
